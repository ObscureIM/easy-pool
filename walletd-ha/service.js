...
var wallet = new TurtleService({
  ...
  bindAddress: '0.0.0.0', // The IP address that turtle-service will bind to
  bindPort: 9070, // The port that turtle-service will bind to
  ...
  daemonRpcPort: 12001, // Daemon RPC port
